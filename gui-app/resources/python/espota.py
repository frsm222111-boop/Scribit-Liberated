...
# Modified since 2018-11-22 from Chiara Ruggeri (support@meteca.org)
#
...
# Or to upload firmware on a companion chip connected to ESP:
# python espota.py -i <ESP_IP_address> -I <Host_IP_address> -p <ESP_port> -P <HOST_port> [-a password] -c -f <spiffs.bin>
#
# Changes
# 2015-09-18:
# - Add option parser.
...
# Changes
# 2018-11-22:
# - Added option to flash companion chip from esp
#
...
def parser(unparsed_args):
  ...
  group.add_option("-c", "--companion",
    dest = "companion",
    action = "store_true",
    help = "Use this option to flash a companion module connected to the module.",
    default = False
  )
  parser.add_option_group(group)
